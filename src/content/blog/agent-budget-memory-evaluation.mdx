...
这篇文章围绕这件事展开。60 万是教学示例，不是论文给你的推荐预算。

本文依据 2026 年 9 月 14 日提交的 When Agents Slow Down 初版，并结合推理预算分配、Reflexion、Hyperband 和 Agent 评测研究。论文结果、假设数字和工程建议会分别说明。本文没有重新运行论文实验。[论文原文](https://arxiv.org/abs/2609.15309)
