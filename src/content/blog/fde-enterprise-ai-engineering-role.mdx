...
<InteractiveHtml
  ...
  height="660"
  caption="站点重建版，非 Notion 原附件。当前连接只能读取到附件块和文件名，无法取得原始 HTML 字节；本面板按正文已核对的数据与公开来源重建。"
/>
...
<InteractiveHtml
  ...
  title="FDE 中国市场公开样本"
  height="680"
  caption="站点重建版，非 Notion 原附件。当前连接无法取得原始 HTML 字节；本面板按正文中的 28 条大厂 JD、公开薪资样本和 2026 年组织动作重建。"
/>
...
<InteractiveHtml
  ...
  title="FDE 真实项目证据浏览器"
  height="720"
  caption="站点重建版，非 Notion 原附件。当前连接无法取得原始 HTML 字节；本面板按正文中 6 个公开案例及其来源重建，并标明公司或项目方自报口径。"
/>
