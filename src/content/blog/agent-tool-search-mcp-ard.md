...
description: '结合 OpenAI Agents API、Anthropic Tool Search、MCP 与 ARD，说明大规模工具系统怎样按需发现和加载工具，并设计可复现的对照实验。'
publishDate: '2026-09-17T00:00:00Z'
tags: ['AI', 'Agent', 'Tool Search', 'MCP', 'Context Engineering']
language: 'zh-CN'
draft: false
---
...
![图 1，全部预加载与按需加载工具定义的区别。](../../assets/blog/agent-tool-search-mcp-ard/2026-09-17-tool-search-flow.svg)
...
![图 2，延迟工具定义与稳定 Prompt Cache 前缀。](../../assets/blog/agent-tool-search-mcp-ard/2026-09-17-defer-loading-cache.svg)
...
![图 4，全部预加载与 Tool Search 的对照实验。](../../assets/blog/agent-tool-search-mcp-ard/2026-09-17-tool-search-experiment.svg)
