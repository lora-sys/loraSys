export interface ShowcaseItem { name: string; description: string; image: string; href: string }
...
export const favorites: ShowcaseItem[] = [
  ...
  ['Music', 'The tracks that keep me company while I build.', 'music.webp', 'https://open.spotify.com/'],
...
].map(([name, description, image, href]) => ({ name, description, image: `/images/favorites/${image}`, href }))
