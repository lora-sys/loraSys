...
export const loraVisuals = {
  heroLora: { src: heroLora, alt: '', decorative: true, widths: [384, 480, 768, 1152, 1536], sizes: '(max-width: 760px) 88vw, 42rem', quality: 72, pages: ['/', '/en/'] },
  heroMochi: { src: heroMochi, alt: '', decorative: true, widths: [192, 384, 576, 768], sizes: '(max-width: 760px) 42vw, 17rem', quality: 80, pages: ['/', '/en/'] },
  heroProps: { src: heroProps, alt: '', decorative: true, widths: [384, 480, 640, 768, 1152, 1536], sizes: '(max-width: 760px) 88vw, 42rem', quality: 72, pages: ['/', '/en/'] },
